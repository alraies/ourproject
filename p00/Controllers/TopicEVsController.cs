...
namespace p00.Controllers
{
    public class TopicEVsController : Controller
    {
        ...
        {
            var topicEVs = db.TopicEVs.Include(t => t.Document).Include(t => t.EvaluationForm).Include(t => t.Teacher);
        ...
        {
            ViewBag.Id = new SelectList(db.Documents, "Id", "Id");
        ...
        public ActionResult Create([Bind(Include = "Id,EvaluationFormId,SectionId,TopicId,TeacherId,Points,Approved")] TopicEV topicEV)
        {
            ...
            ViewBag.Id = new SelectList(db.Documents, "Id", "Id", topicEV.Id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EvaluationFormId,SectionId,TopicId,TeacherId,Points,Approved")] TopicEV topicEV)
        {
            if (ModelState.IsValid)
            {
